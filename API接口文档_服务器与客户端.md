...
```
rtmp://47.107.33.154:1935/live?vhost=vid-7320903/{room_id}_{user_id}
```

**注意**：URL 中的 `?vhost=vid-7320903` 是必须的，否则会导致连接被断开。

**正确示例**：
```
rtmp://47.107.33.154:1935/live?vhost=vid-7320903/room_1780139050530_211
```

**错误示例**（会导致连接断开）：
```
rtmp://47.107.33.154:1935/live/room_1780139050530_211
```
...
```
1. 用户 A 开始推流
   RTMP: rtmp://47.107.33.154:1935/live?vhost=vid-7320903/room_xxx_A
...
1. **vhost 必须指定**：推流 URL 必须包含 `?vhost=vid-7320903`，否则会被断开
